...
const CvPage = () => {
    return (
        ...
        <div className=" text-dul-gray ml-[20vw] xl:ml-[20vw] md:ml-[30vw] pt-[10vh] text-xl">
            ...
            교육
            <br />
            2021 3월~ 재학, 홍익대학교 학사, 회화과, 서울, 한국
            <br />
            <br />

            단체전
            <br />
            2023 성남시 예비예술가 육성사업 - 결과보고회 “XxX”, aftersundayclub, 성남, 한국
            <br />
            2023 필름 &lt;중성인간-뿌리뽑힌 소녀 neutral person-uprooted girl&gt; 스크리닝
            <br />
            ...
            Education
            <br />
            March 2021~ Attending Hongik University, Bachelor of Arts, Department of Painting, Seoul, Korea
            <br />
            <br />

            Group Exhibition
            <br />
            2023 Pre-Artist Promotion Project in Seongnam-si - Result Report Meeting "XxxX", after Sunday Club, Seongnam, Korea
            <br />
